...
export default function Footer() {
  ...
  return (
    <div className="bg-[#013f86] w-full absolute bottom-0 lg:px-[12.5rem] px-[1rem]">
      <div className="mt-16 text-white grid sm:grid-cols-4 gap-10">
        <div>
          <div className="mb-4">
          ...
          <div className="mb-2">
            <p>
              ...
              agency, where every detail is curated to perfection, ensuring you
              not only explore the world.
            </p>
          </div>
        ...
        <div className="col-span-2">
          <p className="md:text-9xl text-5xl text-slate-500 tracking-wide mb-10">
            Let&apos;s Talk
          </p>
